...
RESULTS = [
    ...
    Path("results/eco_governed_experimental_cycle.json"),
    Path("results/eco_governed_experimental_cycle.md"),
    Path("results/eco_real_biological_data_admission_dry_run_report.json"),
    Path("results/eco_real_biological_data_admission_dry_run_report.md"),
