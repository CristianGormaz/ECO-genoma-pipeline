"""
Exporta análisis de rutas confundidas E.C.O.
===========================================

Analiza el holdout extendido y convierte errores/default_state en escenarios
sintéticos sugeridos para ampliar el dataset de forma dirigida.
"""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Exporta análisis de rutas confundidas E.C.O.")
...
def main() -> None:
    ...
    print(markdown)
    print("")
    print("OK: análisis de rutas confundidas E.C.O. generado.")
